 ...
 * Slug: bh-studio/site-footer-with-cta
...
<h2 class="wp-block-heading"><?php esc_html_e( 'Build successful websites', 'bh-studio' ); ?> <br><?php esc_html_e( 'with Cloud Patterns.', 'bh-studio' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-left" style="text-transform:uppercase"><strong style="margin-right: 4px"> </strong><?php esc_html_e( 'Easy to use', 'bh-studio' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"textTransform":"uppercase"}}} -->
<p class="has-text-align-left" style="text-transform:uppercase"><strong style="margin-right: 4px">✓ </strong><?php esc_html_e( 'Beautifully designed patterns', 'bh-studio' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading has-contrast-color has-text-color has-link-color"><?php esc_html_e( 'About', 'bh-studio' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading {"level":3,"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"textColor":"contrast"} -->
<h3 class="wp-block-heading has-contrast-color has-text-color has-link-color"><?php esc_html_e( 'Helpful Tools', 'bh-studio' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading {"level":3,"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"textColor":"contrast"} -->
<h3 class="wp-block-heading has-contrast-color has-text-color has-link-color"><?php esc_html_e( 'Learn More', 'bh-studio' ); ?></h3>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-contrast-midtone-color has-text-color has-link-color has-small-font-size" style="border-top-width:1px;padding-top:var(--wp--preset--spacing--40)"><?php esc_html_e( '© Copyright 2024. All rights reserved.', 'bh-studio' ); ?></p>
<!-- /wp:paragraph --></footer>
<!-- /wp:group --></div>
<!-- /wp:group -->