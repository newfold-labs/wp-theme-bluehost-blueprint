 ...
 * Slug: bh-studio/site-footer-with-contacts
...
<p><?php esc_html_e( 'Give us a call (555) 123 45678', 'bh-studio' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Monday - Friday | 7am - 5pm PST', 'bh-studio' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-text-align-center"><?php esc_html_e( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'bh-studio' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-text-align-center has-small-font-size"><?php esc_html_e( '&copy; Copyright 2025. All rights reserved.', 'bh-studio' ); ?></p>
<!-- /wp:paragraph --></footer>
<!-- /wp:group -->