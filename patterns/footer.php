...
echo sprintf( esc_html__( 'Proudly Powered by %1$sNewfold Digital%2$s', 'nextgen-theme' ), '<a href="' . esc_url( 'https://newfold.com' ) . '" rel="nofollow">', '</a>' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->