...
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":1,"className":"","style":{"layout":{"selfStretch":"fit","flexSize":null},"typography":{"fontSize":"3.4em"}}} -->
<h1 class="wp-block-heading has-text-align-left" style="font-size:3.4em">
<?php esc_html_e( 'Actors, Cameras and Achievements', 'bluehost-blueprint' ); ?>
</h1>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-medium-font-size has-custom-font-size wp-element-button"><?php esc_html_e( 'Prepare Now', 'bluehost-blueprint' ); ?></a></div>
<!-- /wp:button -->
...
<figure class="wp-block-image size-large has-custom-border" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:var(--wp--preset--spacing--50)"><img src="https://images.unsplash.com/photo-1467810563316-b5476525c0f9?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;q=80&amp;w=800&amp;h=800&amp;crop=" alt="" style="border-top-left-radius:400px;border-top-right-radius:400px;border-bottom-left-radius:400px;border-bottom-right-radius:8px;aspect-ratio:1;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:separator {"className":"is-style-dots","style":{"spacing":{"margin":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}}} -->
